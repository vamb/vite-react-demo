...
const MinutePart = () => {
  ...
  const { minuteRadioValue, minutePeriodStart, minutePeriodEnd, minuteCycleStart,
    minuteCycleStep, minuteOrderArr } = pageData
          ...
          <Radio value={PageConstant.CRON_RADIO_OPTS.OPT_2}>
            <div className={'option-text'}>
              ...
              <InputNumber
                ...
                disabled={PageConstant.CRON_RADIO_OPTS.OPT_2 !== minuteRadioValue}
          ...
          <Radio value={PageConstant.CRON_RADIO_OPTS.OPT_3}>
            <div className={'option-text'}>
              ...
              <InputNumber
                ...
                disabled={PageConstant.CRON_RADIO_OPTS.OPT_3 !== minuteRadioValue}
            ...
            <div className={'option-checkbox-group'}>
              ...
              <div className={'check-box-group'}>
                <Checkbox.Group
                  ...
                  style={{width: '550px'}}
                  disabled={PageConstant.CRON_RADIO_OPTS.OPT_4 !== minuteRadioValue}
