...
const WeekPart = () => {
  ...
  const { weekRadioValue, weekPeriodStart, weekPeriodEnd,
    weekCycleStart, weekCycleStep, weekRelated, weekOrderArr, dayStr } = pageData
  ...
  const pageDataChange = (inputObj) => {
    ...
    const tempDayStr = PageConstant.dayOrWeekRadioChangeCheck(dispatchObj.weekRadioValue, dayStr)
    if(tempDayStr !== dayStr){
      // dispatchObj['dayStr'] = tempDayStr
      // dispatchObj['dayRadioValue'] = PageConstant.MARK.ALL === tempDayStr? 1: 2
      dispatchObj = PageConstant.overwriteRulesAndCombineData(dispatchObj, tempDayStr, PageConstant.CONFLICT.WEEK_2_DAY)
      dispatchPageData({
        type: PageConstant.UPDATE_DATA,
        data: { conflictObj: dispatchObj, conflictModalVisible: true, conflictType: PageConstant.CONFLICT.WEEK_2_DAY }
      })
      return
    }
          ...
          <Radio value={PageConstant.CRON_RADIO_OPTS.OPT_3}>
            <div className={'option-text'}>
              ...
              <InputNumber
                ...
                disabled={PageConstant.CRON_RADIO_OPTS.OPT_3 !== weekRadioValue}
          ...
          <Radio value={PageConstant.CRON_RADIO_OPTS.OPT_4}>
            <div className={'option-text'}>
              ...
              <InputNumber
                ...
                disabled={PageConstant.CRON_RADIO_OPTS.OPT_4 !== weekRadioValue}
          ...
          <Radio value={PageConstant.CRON_RADIO_OPTS.OPT_5}>
            <div className={'option-text'}>
              ...
              <InputNumber
                value={weekRelated}
                style={{width: '80px'}} min={1} max={7} step={1}
                disabled={PageConstant.CRON_RADIO_OPTS.OPT_5 !== weekRadioValue}
            ...
            <div className={'option-checkbox-group'}>
              ...
              <div className={'check-box-group'}>
                <Checkbox.Group
                  value={weekOrderArr}
                  style={{width: '550px'}}
                  disabled={PageConstant.CRON_RADIO_OPTS.OPT_6 !== weekRadioValue}
