...
const SecondPart = () => {
  ...
  const { secondRadioValue, secondPeriodStart, secondPeriodEnd, secondCycleStart,
    secondCycleStep, secondOrderArr } = tempData
          ...
          <Radio value={TempConstant.CRON_RADIO_OPTS.OPT_2}>
            <div className={'option-text'}>
              ...
              <InputNumber
                ...
                disabled={TempConstant.CRON_RADIO_OPTS.OPT_2 !== secondRadioValue}
          ...
          <Radio value={TempConstant.CRON_RADIO_OPTS.OPT_3}>
            <div className={'option-text'}>
              ...
              <InputNumber
                ...
                disabled={TempConstant.CRON_RADIO_OPTS.OPT_3 !== secondRadioValue}
            ...
            <div className={'option-checkbox-group'}>
              ...
              <div className={'check-box-group'}>
                <Checkbox.Group
                  ...
                  disabled={TempConstant.CRON_RADIO_OPTS.OPT_4 !== secondRadioValue}
