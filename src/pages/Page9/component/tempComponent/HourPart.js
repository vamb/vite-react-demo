...
const HourPart = () => {
  ...
  const { hourRadioValue, hourPeriodStart, hourPeriodEnd, hourCycleStart,
    hourCycleStep, hourOrderArr, } = tempData
          ...
          <Radio value={TempConstant.CRON_RADIO_OPTS.OPT_2}>
            <div className={'option-text'}>
              ...
              <InputNumber
                ...
                disabled={TempConstant.CRON_RADIO_OPTS.OPT_2 !== hourRadioValue}
          ...
          <Radio value={TempConstant.CRON_RADIO_OPTS.OPT_3}>
            <div className={'option-text'}>
              ...
              <InputNumber
                ...
                disabled={TempConstant.CRON_RADIO_OPTS.OPT_3 !== hourRadioValue}
            ...
            <div className={'option-checkbox-group'}>
              ...
              <div className={'check-box-group'}>
                <Checkbox.Group
                  value={hourOrderArr}
                  style={{width: '550px'}}
                  disabled={TempConstant.CRON_RADIO_OPTS.OPT_4 !== hourRadioValue}
