...
const DayOrWeekConflictModal = () => {
  ...
  const { conflictModalVisible, conflictObj, conflictType } = tempData
  ...
  return (
    ...
    >
      <Wrapper>
        ...
        <div>
          {
            TempConstant.CONFLICT.DAY_2_WEEK === conflictType &&
          ...
          {
            TempConstant.CONFLICT.WEEK_2_DAY === conflictType &&
