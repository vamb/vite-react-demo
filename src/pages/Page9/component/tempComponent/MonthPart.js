...
const MonthPart = () => {
  ...
  const { monthRadioValue, monthPeriodStart, monthPeriodEnd,
    monthCycleStart, monthCycleStep, monthOrderArr } = tempData
          ...
          <Radio value={TempConstant.CRON_RADIO_OPTS.OPT_2}>
            <div className={'option-text'}>
              ...
              <InputNumber
                ...
                disabled={TempConstant.CRON_RADIO_OPTS.OPT_2 !== monthRadioValue}
          ...
          <Radio value={TempConstant.CRON_RADIO_OPTS.OPT_3}>
            <div className={'option-text'}>
              ...
              <InputNumber
                ...
                disabled={TempConstant.CRON_RADIO_OPTS.OPT_3 !== monthRadioValue}
            ...
            <div className={'option-checkbox-group'}>
              ...
              <div className={'check-box-group'}>
                <Checkbox.Group
                  style={{width: '550px'}}
                  value={monthOrderArr}
                  disabled={TempConstant.CRON_RADIO_OPTS.OPT_4 !== monthRadioValue}
